...
const schema = yup.object().shape({
  ...
  location: yup.string(),
  salary: yup.string().nullable(), // using string to allow empty or descriptive range
  platform: yup.string(),
...
const AddApplication = () => {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm({
    ...
    defaultValues: { status: 'Applied', appliedDate: new Date().toISOString().split('T')[0] }
  });
    ...
    <div className="page form-container">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          ...
          <input {...register('platform')} placeholder="e.g. LinkedIn, Career Page" />
        </div>
        ...
        <div className="form-group">
          <label>Notes</label>
          <textarea {...register('notes')} placeholder="Add any notes here..." rows="3"></textarea>
        </div>
